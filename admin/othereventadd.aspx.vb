...
Imports System.Data
Imports System.IO
Partial Class admin_othereventadd
    Inherits System.Web.UI.Page
    Dim intReturn As String = "0"
    Dim clsRefdata As New clsRefdata
    Dim strFolderPath As String = Server.MapPath("/XML/otherevents/") '"C://work/sis/xml/otherevents/" '
            ...
            Else
                ...
                If intReturn <> 0 Then
                    ...
                    Try
                        ...
                        Dim objXMLTW As New XmlTextWriter(Server.MapPath("/XML/otherevents/") & intReturn & ".xml", enc)
                        objXMLTW.WriteStartDocument()
                        objXMLTW.Formatting = Formatting.Indented
