<%@ Page Language="VB" MasterPageFile="~/admin/Menu.master" AutoEventWireup="false" Debug="true" ValidateRequest="false" CodeFile="articles.aspx.vb" Inherits="admin_articles" title="Articles" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <td>
        ...
        <table>
            ...
            <tr>
                <td><b>Article Category</b><br />
                <asp:DropDownList ID="ddlCategory" runat="server"></asp:DropDownList>
                <asp:RequiredFieldValidator id="RequiredFieldValidator5" runat="server" ControlToValidate="ddlCategory" ErrorMessage="Article Category is missing"  Display="Dynamic" Text="*" />
                </td>
            </tr>

            <tr>
                <td><b>Article Date</b><br />
            ...
            <tr>
                ...
                <asp:RequiredFieldValidator id="RequiredFieldValidator4" runat="server" ControlToValidate="txtAuthor" ErrorMessage="Author is missing"  Display="Dynamic" Text="*" />
                </td>
            </tr>
            
            <tr>
                <td><b>Mini description</b><br />
                <textarea id="txtContent1" runat="server" cols="100" rows="10"></textarea>
                <asp:RequiredFieldValidator id="RequiredFieldValidator10" runat="server" ControlToValidate="txtContent1" ErrorMessage="Mini description is missing"  Display="Dynamic" Text="*" />
                </td>
            </tr>
