<%@ Page Language="VB" MasterPageFile="~/admin/Menu.master" AutoEventWireup="false" CodeFile="eventlist.aspx.vb" Inherits="admin_eventlist" title="Events" %>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Article Number">
                                <ItemTemplate>
                                    ...
                                    NavigateUrl='<%# "eventsadd.aspx?aid=" & DataBinder.Eval(Container.DataItem,"EventID") %>'></asp:HyperLink>
