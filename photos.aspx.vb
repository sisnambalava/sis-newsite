...
Partial Class photos
    ...
    Private Sub LoadPageDetails()
        ...
        'page title
        Page.Header.Title = "South Indian Society Event Photos & Videos"

        'meta keywords
        metaTagKeywords = DirectCast(Page.Master.FindControl("keywords"), HtmlMeta)
        metaTagKeywords.Attributes.Add("content", "sis uk, south indian society london, sis events, sis event photos, pictures")

        'meta description
        metaTagDescription = DirectCast(Page.Master.FindControl("description"), HtmlMeta)
        metaTagDescription.Attributes.Add("content", "A section to view all latest photos and videos of London South Indian Society events and celebrations.")
