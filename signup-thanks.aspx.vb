...
Partial Class signup_thanks
    ...
    Private Sub LoadPageDetails()
        ...
        'page title
        Page.Header.Title = "South Indian Society Newsletter Signup"
        ...
        metaTagDescription.Attributes.Add("content", "South Indian Society Newsletter Signup thank you page.")
