Imports System.Data
Imports System.IO
Partial Class articles_religion_default
    Inherits System.Web.UI.Page
    Dim clsRefData As New clsRefdata
    Dim strCategoryName As String = "religion"
    ...
    Private Sub LoadPageDetails()
        ...
        pTitle = "Articles about Hindu Religion"
        pMetaKeywords = "sis uk, south indian society, tamil functions, hindu religion"
        pMetaDesc = "Useful articles about hindu religion, tamil functions and their meaning from South Indian Society."
        ...
        ltH1.Text = "Articles - Hindu Religion"
    End Sub
