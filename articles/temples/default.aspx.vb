...
Partial Class articles_temples_default
    Inherits System.Web.UI.Page
    Dim clsRefData As New clsRefdata
    Dim strCategoryName As String = "temples"
    ...
    Private Sub LoadPageDetails()
        ...
        pTitle = "Indian Temples"
        pMetaKeywords = "sis uk, south indian society, tamil nadu temples, India temples "
        pMetaDesc = "A section to view detailed information about different temples in TamilNadu and other parts of India presented by South Indian Society."
