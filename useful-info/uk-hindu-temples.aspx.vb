Imports System
Imports System.Data
Partial Class useful_info_uk_hindu_temples
    ...
    Private Sub LoadPageDetails()
        ...
        'page title
        Page.Header.Title = "South Indian Society | UK Hindu Temples"

        'meta keywords
        metaTagKeywords = DirectCast(Page.Master.FindControl("keywords"), HtmlMeta)
        metaTagKeywords.Attributes.Add("content", "sis uk, south indian society london, Panchangam, uk tamil temples, hindu temples")

        'meta description
        metaTagDescription = DirectCast(Page.Master.FindControl("description"), HtmlMeta)
        metaTagDescription.Attributes.Add("content", "List of all Hindu and Tamil temples in London, Birmingham and other parts of United Kingdom.")
